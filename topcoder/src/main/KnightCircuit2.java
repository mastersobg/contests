...
public class KnightCircuit2 {
	...
	public static void main(String[] args) {
		try {
			eq(0, (new KnightCircuit2()).maxSize(4, 45000), 1);
			eq(0, (new KnightCircuit2()).maxSize(1, 1), 1);
			eq(1, (new KnightCircuit2()).maxSize(15, 2), 8);
			eq(2, (new KnightCircuit2()).maxSize(100, 100), 10000);
		} catch (Exception exx) {
