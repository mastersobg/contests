...
public class TheSwapsDivOne {
	...
	public static void main(String[] args) {
		try {
			eq(0, (new TheSwapsDivOne()).find(new String[] { "4", "77" }, 1),
					10.0);
			eq(1, (new TheSwapsDivOne()).find(new String[] { "4", "77" }, 47),
					10.0);
			eq(2,
					(new TheSwapsDivOne()).find(new String[] { "1", "1", "1",
							"1", "1", "1", "1" }, 1000000), 3.0);
			eq(3,
					(new TheSwapsDivOne()).find(new String[] {
							"572685085149095989026478064633266980348504469",
							"19720257361", "9", "69" }, 7), 98.3238536775161);
		} catch (Exception exx) {
