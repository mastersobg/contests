...
public class TheNumberGameDivOne {
	...
	public String find(long n) {
		return check(n) == 1 ? "John" : "Brus";
	}

	// BEGIN CUT HERE
	public static void main(String[] args) {
		try {
			eq(1, new TheNumberGameDivOne().find(100000000000000000l), "John");
			eq(0, (new TheNumberGameDivOne()).find(6L), "John");
			eq(1, (new TheNumberGameDivOne()).find(2L), "Brus");
			eq(2, (new TheNumberGameDivOne()).find(747L), "Brus");
			eq(3, (new TheNumberGameDivOne()).find(128L), "Brus");
		} catch (Exception exx) {
