...
public class Solution {
    ...
    long solve() throws IOException {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            events.add(new Event(y1, y2 - 1, x1, true));
            events.add(new Event(y1, y2 - 1, x2, false));
        }
        ...
        for (int i = 0; i < events.size(); ++i) {
            ...
            if (i > 0) {
                int count = MAX + 1 - tree.getMinimumCount();
                //dbg(count);
    ...
    void test() throws IOException {
        ...
        for (int t = 0; t < 100; ++t) {
            ...
            for (int i = 0; i < 1000; ++i) {
                int x1 = rnd.nextInt(1000000);
                int y1 = rnd.nextInt(1000000);
                int addX = rnd.nextInt(1000000) + 1;
                int addY = rnd.nextInt(1000000) + 1;
                int x2 = min(x1 + addX, 1000000);
                int y2 = min(y1 + addY, 1000000);
